...
function [newSeg,Vnew,newSegAll,VAllnew] = rotateNeuronSegInit(Vnew,VAllnew,DM,SLA,segV,segVAll,segVparent,segN,percent)
...
%     close(h);
    ...
    for i=1 % 
        [segV,segVAll,eVector, theta, translationPT] = rotateNeuronVectorsInit(segV,segVAll,segValign,percent,i);
