...
function [newSeg,Vnew,newSegAll,VAllnew] = rotateNeuronSegW(Vnew,VAllnew,DM,SLA,segV,segVAll,segN,percent)
    ...
    for i=(size(segV,1)-1):-1:3
        [segV,segVAll,eVector, theta, translationPT] = rotateNeuronVectors(segV,segVAll,percent,i);
