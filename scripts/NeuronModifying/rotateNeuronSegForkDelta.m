...
function [newSeg,Vnew,newSegAll,VAllnew] = rotateNeuronSegForkDelta(Vnew,VAllnew,DM,SLA,segV,segVAll,segVparent,segN,thetaFixed)
...
%     close(h);
    ...
    %         segVAll = rotateSegByAngle(segRingsToRot,eVector,theta,translationPT);%--
            ...
            [segV,segVAll,eVector, theta, translationPT] = rotateNeuronVectorsForkDelta(segV,segVAll,segValign,0,i);
        end
