function y = writeOBJFulltest(V,F,G,num,folderName,folderPath)
...
%%%%%%%
    % folderPath = 'N:\NeuronOBJsEnd\Basal\' ;
%%%%%%% SSD path %%%%%%
    path = [folderPath num2str(100*num,'%03.0f') '\'];%amended this 6/22/2017, was um2str(100*num,'%3.0f')
%%%%%%%
    if exist(path,'dir') == 0 
        mkdir(path)
    end
