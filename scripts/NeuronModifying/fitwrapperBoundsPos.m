...
function [r] = fitwrapperBoundsPos(l,n,res,LSCO,FSCO,OrderOfMagnitude)
...
r.L10BS = log10(l);%log10(1./l);
r.L10N = log10(n);


LSCOInd = find(res >1/LSCO,1,'first'); %1 = 'one': BB0x = L/LSCO, BBOx = res*L => res = 1/LSCO
