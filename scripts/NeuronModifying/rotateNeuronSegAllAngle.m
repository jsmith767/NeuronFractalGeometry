...
function [newSeg,Vnew,newSegAll,VAllnew] = rotateNeuronSegAllAngle(Vnew,VAllnew,DM,SLA,segV,segVAll,segVparent,segN,percent)
...
%     close(h);
    ...
    for i=(size(segV,1)-1):-1:1 % 
        [segV,segVAll,eVector, theta, translationPT] = rotateNeuronVectorsAllAngle(segV,segVAll,segValign,percent,i);
