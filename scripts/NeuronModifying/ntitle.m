...
for n=1:2:length(varargin)
    if strcmpi(varargin{n},'location')
        if strcmpi(varargin{n+1},'northwest')
            set(h,'horizontalalignment','left','verticalalignment','top','position',[0.02 0.99 0])
        ...
        elseif strcmpi(varargin{n+1},'southeast')
            set(h,'horizontalalignment','right','verticalalignment','bottom','position',[0.99 0.02 0])
