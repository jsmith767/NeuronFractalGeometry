...
%pretty sure this is the good one as of 10/23/2019
function [dataStruct,vM,fM,allFacesToExclude] =getSurfArea(dataStruct,method,fineMeshIt)
...
%         dataStruct(i).data.(genvarname(method))(j).efM{fineMeshIt+1} = allFacesToExclude;
        ...
        dataStruct(i).data.(genvarname(method)) = rmfield(dataStruct(i).data.(genvarname(method)),'SAne');
%     toc    
    end
%     try
