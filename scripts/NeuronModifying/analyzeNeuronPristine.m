...
% DOES NOT remove the first group of vertices!!! This is for neurons that
% already have ben processed once.
...
function [points,allPoints,lengths,faces,groups] = analyzeNeuronPristine(filePath,fileName)
