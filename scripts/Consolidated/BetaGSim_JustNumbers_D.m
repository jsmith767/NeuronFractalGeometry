...
%     mask = imread('K:\Keck\MicroscopeImages\BP1\Pluth\BP1_20x_CNT\FullImage\mask.tif');%for D = 1.1
    ...
    savefilename = strcat('D1.1I4-BetaGSim-',num2str(NumSamps),'Samples-R',num2str(CellRad));
elseif UseMask == 2
%     mask = imread('K:\Keck\MicroscopeImages\BP10\Pluth\BP10_20x_CNT\FullImage\mask.tif');%for D = 1.5
    ...
    savefilename = strcat('D1.5I4-BetaGSim-',num2str(NumSamps),'Samples-R',num2str(CellRad));
elseif UseMask == 3
%     mask = imread('K:\Keck\MicroscopeImages\BO1-1\Pluth\BO1-1_20x_CNT\FullSample\mask.tif');%for D = 2, I = 4
    ...
    savefilename = strcat('D2.0I4-BetaGSim-',num2str(NumSamps),'Samples-R',num2str(CellRad));
elseif UseMask == 4
%     mask = imread('K:\Keck\MicroscopeImages\BK1-1\Pluth\BK1-1_20x_CNT\FullSample\mask.tif');%for D = 2, I = 5
    ...
    savefilename = strcat('D2.0I5-BetaGSim-',num2str(NumSamps),'Samples-R',num2str(CellRad));
elseif UseMask == 5
%     mask = imread('K:\Keck\MicroscopeImages\BP11\Pluth\BP11_20x_CNT\FullImage\mask.tif');%for D = 2, I = 6
    ...
    savefilename = strcat('D2.0I6-BetaGSim-',num2str(NumSamps),'Samples-R',num2str(CellRad));
end
