...
for masknum = 1:5
    if masknum == 1
        D1p1I4 = load(strcat('MATs\D1.1I4-BetaGSim-',num2str(NumSamps),'Samples-R31.mat'));%_pad.mat'));
    elseif masknum == 2
        D1p5I4 = load(strcat('MATs\D1.5I4-BetaGSim-',num2str(NumSamps),'Samples-R31.mat'));%_pad.mat'));
    elseif masknum == 3
        D2p0I4 = load(strcat('MATs\D2.0I4-BetaGSim-',num2str(NumSamps),'Samples-R31.mat'));%_pad.mat'));
    elseif masknum == 4 
        D2p0I5 = load(strcat('MATs\D2.0I5-BetaGSim-',num2str(NumSamps),'Samples-R31.mat'));%_pad.mat'));
    elseif masknum == 5
        D2p0I6 = load(strcat('MATs\D2.0I6-BetaGSim-',num2str(NumSamps),'Samples-R31.mat'));%_pad.mat'));
    end
end
