...
NNInd = 5;
NDlims = [1.25 1.68];
F4LTL = [0.41 0.44 0.47];
F4LT = [0.41 0.44 0.47];
F4RTL = [1.38 1.43 1.48 1.53];
F4RT = [1.38 1.43 1.48 1.53];
Dticks = [1.3 1.4 1.5 1.6];
DtickLabels = [1.3 1.4 1.5 1.6];
% Ny2Ticks = [0.05 0.15 0.25];
% Ny2TickLabels = [0.05 0.15 0.25];
Ny1Ticks = [0.36 0.45 0.54];
Ny1TickLabels = [0.36 0.45 0.54];
Ny2Ticks = [0.04 0.14 0.24];
Ny2TickLabels = [0.04 0.14 0.24];
Ny3Ticks = [0.04 0.14 0.24];
Ny3TickLabels = [0.04 0.14 0.24];
...
HTy1Ticks = [0.225 0.232 0.239];
HTy1TickLabels = [0.225 0.232 0.239];
HTy2Ticks = [0.01 0.04 0.07];
HTy2TickLabels = [0.01 0.04 0.07];
