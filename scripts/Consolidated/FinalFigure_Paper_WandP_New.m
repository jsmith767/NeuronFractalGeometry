...
R = cell(1,2);
L = cell(1,2);
[D{1,1},V{1,1},P{1,1},BA{1,1},M{1,1},SA{1,1},SAB{1,1},VM{1,1},R{1,1},L{1,1},BDbyM{1,1},BVbyM{1,1},BPbyM{1,1},BBAbyM{1,1},BMbyM{1,1},BSAbyM{1,1},BSABbyM{1,1},BVMbyM{1,1},BRbyM{1,1},BLbyM{1,1},~] = GetNData_W_New(plottingN);
[D{1,2},V{1,2},P{1,2},BA{1,2},M{1,2},SA{1,2},SAB{1,2},VM{1,2},R{1,2},L{1,2},BDbyM{1,2},BVbyM{1,2},BPbyM{1,2},BBAbyM{1,2},BMbyM{1,2},BSAbyM{1,2},BSABbyM{1,2},BVMbyM{1,2},BRbyM{1,2},BLbyM{1,2},~] = GetNData_P_New(plottingN);
...
BPBAbyMAve{1,1} = zeros(1,BNumMods-(FirstMod-1));
BPBAbyMDev{1,1} = zeros(1,BNumMods-(FirstMod-1));
...
BPBAbyMAve{1,2} = zeros(1,BNumMods-(FirstMod-1));
BPBAbyMDev{1,2} = zeros(1,BNumMods-(FirstMod-1));
...
for i = 1:BNumMods-(FirstMod-1)
    ...
    BPBAbyMAve{1,1}(1,i) = mean(BPbyM{1,1}(i,:)./BBAbyM{1,1}(i,:));
    BPBAbyMDev{1,1}(1,i) = std(BPbyM{1,1}(i,:)./BBAbyM{1,1}(i,:));
...
[~, ~, NPoBAAve{1,1}, NPoBADev{1,1}] = BinDatabyD(binRange,Numbins,D{1,1},P{1,1}./BA{1,1});
...
for i = 1:BNumMods-(FirstMod-1)
    ...
    BPBAbyMAve{1,2}(1,i) = mean(BPbyM{1,2}(i,:)./BBAbyM{1,2}(i,:));
    BPBAbyMDev{1,2}(1,i) = std(BPbyM{1,2}(i,:)./BBAbyM{1,2}(i,:));
...
[~, ~, NPoBAAve{1,2}, NPoBADev{1,2}] = BinDatabyD(binRange,Numbins,D{1,2},P{1,2}./BA{1,2});
...
HTbinRange = [min(BDbyM{1,1}(5,:)) max(BDbyM{1,1}(5,:))];
HTNumbins = 10;
[HTDAve, HTDDev, HTAoAAve, HTAoADev] = BinDatabyD(NDlims,HTNumbins,BCD(1,NDvalInd),MassSA./CHSA(1,NDvalInd));
[~, ~, HTPoMAve, HTPoMDev] = BinDatabyD(NDlims,HTNumbins,BCD(1,NDvalInd),AveP(1,NDvalInd)/MassSA);
[~, ~, HTPoAAve, HTPoADev] = BinDatabyD(NDlims,HTNumbins,BCD(1,NDvalInd),AveP(1,NDvalInd)./CHSA(1,NDvalInd));
[~, ~, HTVFAve, HTVFDev] = BinDatabyD(NDlims,HTNumbins,BCD(1,NDvalInd),MassV./CHV(1,NDvalInd));
...
if ShowFig6 == 1
    ...
    hold(HTP1,'on');
    plot(HTDAve,HTPoMAve,'s','Color',clrHTreeBins,'LineStyle','-','LineWidth',3,'MarkerSize',HTreeBinSize,'MarkerFaceColor', clrHTreeBins, 'MarkerEdgeColor', clrHTreeBins);
    scatter(BCD(1,StraightHInd),AveP(1,StraightHInd)/MassSA,HTDotSize+20,'o','MarkerFaceColor', [197 98 41]/255, 'MarkerEdgeColor', [197 98 41]/255)
    xlim(NDlims);
    ylim(plotrangeHCoS);
...
%     ylbHTP1 = ylabel('$\frac{P}{A_S}$','Interpreter','latex','Rotation',0,'HorizontalAlignment','left','VerticalAlignment','middle');
    ...
    hold(HTP2,'on');
    plot(HTDAve,HTAoAAve,'s','Color',clrHTreeBins,'LineStyle','-','LineWidth',3,'MarkerSize',HTreeBinSize,'MarkerFaceColor', clrHTreeBins, 'MarkerEdgeColor', clrHTreeBins);
    scatter(BCD(1,StraightHInd),MassSA./CHSA(1,StraightHInd),HTDotSize+20,'o','MarkerFaceColor', [197 98 41]/255, 'MarkerEdgeColor', [197 98 41]/255)
    xlim(NDlims);
    ylim(plotrangeHSoBA);
...
%     ylbHTP2 = ylabel('$\frac{A_S}{A_B}$','Interpreter','latex','Rotation',0,'HorizontalAlignment','left','VerticalAlignment','middle');
    ...
    hold(HTP3,'on');
    plot(HTDAve,HTPoAAve,'s','Color',clrHTreeBins,'LineStyle','-','LineWidth',3,'MarkerSize',HTreeBinSize,'MarkerFaceColor', clrHTreeBins, 'MarkerEdgeColor', clrHTreeBins);
    scatter(BCD(1,StraightHInd),AveP(1,StraightHInd)./CHSA(1,StraightHInd),HTDotSize+20,'o','MarkerFaceColor', [197 98 41]/255, 'MarkerEdgeColor', [197 98 41]/255)
    xlim(NDlims);
    ylim(plotrangeHCoBA);
...
%     ylbHTP3 = ylabel('$\frac{P}{A_B}$','Interpreter','latex','Rotation',0,'HorizontalAlignment','left','VerticalAlignment','middle');
    ...
    if PlotVForRho == 1
        ...
        hold(HTP4,'on');
%         scatter(BCD(1,StraightHInd),(CHV(1,StraightHInd)-MassV)./CHV(1,StraightHInd),HTDotSize+5,'o','MarkerFaceColor', [0 0 0], 'MarkerEdgeColor', [0 0 0])
...
%         set(ylbHTP4,'Units','Normalized','Position',[1.118, 0.5]);
        ...
        hold(HTP4,'on');
        plot(HTDAve,HTVFAve,'s','Color',clrHTreeBins,'LineStyle','-','LineWidth',3,'MarkerSize',HTreeBinSize,'MarkerFaceColor', clrHTreeBins, 'MarkerEdgeColor', clrHTreeBins);
        scatter(BCD(1,StraightHInd),MassV./CHV(1,StraightHInd),HTDotSize+20,'o','MarkerFaceColor', [197 98 41]/255, 'MarkerEdgeColor', [197 98 41]/255)
