...
scatter(ax3P,BDbyM(5,:),BPbyM(5,:)./BMbyM(5,:),'.','MarkerFaceColor',clr(5,:),'MarkerEdgeColor',clr(5,:))
...
scatter(ax3V,BDbyM(5,:),1./BVbyM(5,:),'.','MarkerFaceColor',clr(5,:),'MarkerEdgeColor',clr(5,:))
...
scatter(ax7C,BDbyM(5,:),BPbyM(5,:)./BSAbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangex)
hold(ax7C,'off');
ax7P = subplot(2,3,2);
hold(ax7P,'on');
...
scatter(ax7P,BDbyM(5,:),BPbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangex)
hold(ax7P,'off');
ax7M = subplot(2,3,3);
hold(ax7M,'on');
...
scatter(ax7M,BDbyM(5,:),BMbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangex)
hold(ax7M,'off');
ax7L = subplot(2,3,5);
hold(ax7L,'on');
...
scatter(ax7L,BDbyM(5,:),BLbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangex)
hold(ax7L,'off');
ax7V = subplot(2,3,6);
hold(ax7V,'on');
...
scatter(ax7V,BDbyM(5,:),1./BVbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangex)
hold(ax7V,'off');
% samexaxis('abc','xmt','on','ytac','join','yld',1);
...
scatter(ax6C,BMbyM(5,:),BPbyM(5,:)./BSAbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangeM)
hold(ax6C,'off');
ax6P = subplot(2,3,2);
hold(ax6P,'on');
...
scatter(ax6P,BMbyM(5,:),BPbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangeM)
hold(ax6P,'off');
ax6V = subplot(2,3,3);
hold(ax6V,'on');
...
scatter(ax6V,BMbyM(5,:),1./BVbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangeM)
hold(ax6V,'off');
ax6D = subplot(2,3,5);
hold(ax6D,'on');
...
scatter(ax6D,BMbyM(5,:),BDbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangeM)
hold(ax6D,'off');
ax6L = subplot(2,3,6);
hold(ax6L,'on');
...
scatter(ax6L,BMbyM(5,:),BLbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangeM)
hold(ax6L,'off');
% samexaxis('abc','xmt','on','ytac','join','yld',1);
...
scatter(ax8C,BLbyM(5,:),BPbyM(5,:)./BSAbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangeL)
hold(ax8C,'off');
ax8P = subplot(2,3,2);
hold(ax8P,'on');
...
scatter(ax8P,BLbyM(5,:),BPbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangeL)
hold(ax8P,'off');
ax8V = subplot(2,3,3);
hold(ax8V,'on');
...
scatter(ax8V,BLbyM(5,:),1./BVbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangeL)
hold(ax8V,'off');
ax8D = subplot(2,3,5);
hold(ax8D,'on');
...
scatter(ax8D,BLbyM(5,:),BDbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangeL)
hold(ax8D,'off');
ax8L = subplot(2,3,6);
hold(ax8L,'on');
...
scatter(ax8L,BLbyM(5,:),BMbyM(5,:),'.','MarkerFaceColor', clr(5,:), 'MarkerEdgeColor', clr(5,:))
xlim(plotrangeL)
hold(ax8L,'off');
% samexaxis('abc','xmt','on','ytac','join','yld',1);
...
[~, ~, SoBAAve, SoBADev] = BinDatabyD(binRange,Numbins,D,SA./(4*pi.*(R).^2));
[~, ~, CoSAve, CoSDev] = BinDatabyD(binRange,Numbins,D,P./SA);
[~, ~, CoBAAve, CoBADev] = BinDatabyD(binRange,Numbins,D,P./(4*pi.*(R).^2));
[~, ~, VFAve, VFDev] = BinDatabyD(binRange,Numbins,D,((4*pi/3.*(R).^3)-VM)./(4*pi/3.*(R).^3));
figure('Name','21','units','normalized','outerposition',[1.02 0.12 0.6 0.85])
ax21SoBA = subplot(2,2,1);
hold(ax21SoBA,'on');
xlb21SoBA = xlabel('Fractal Dimension (D)');
ylb21SoBA = ylabel('SA/SA_R');
% set(ylb21SoBA, 'Units', 'Normalized', 'Position', [-0.05, 0.5, 0]);
ax21SoBA.FontSize = PlotFont;
for i = 1:BNumMods
    scatter(ax21SoBA,BDbyM(order(i),:),BSAbyM(order(i),:)./(4*pi.*BRbyM(order(i),:).^2),'.','MarkerFaceColor', clr(i,:), 'MarkerEdgeColor', clr(i,:))
end
errorbar(ax21SoBA,DAve,SoBAAve,SoBADev,SoBADev,DDev,DDev,'ks','LineWidth',2);
xlim(plotrangex)
% ylim(plotrangeSoBA)
hold(ax21SoBA,'off');
ax21CoS = subplot(2,2,2);
hold(ax21CoS,'on');
xlb21CoS = xlabel('Fractal Dimension (D)');
ylb21CoS = ylabel('Connectivity (C)');
% set(ylb, 'Units', 'Normalized', 'Position', [-0.05, 0.5, 0]);
ax21CoS.FontSize = PlotFont;
% ttl21CoS = title('Basal (All Angles)');
% ttl21CoS.FontSize = TitleFont;
for i = 1:BNumMods
    scatter(ax21CoS,BDbyM(order(i),:),BPbyM(order(i),:)./BSAbyM(order(i),:),'.','MarkerFaceColor', clr(i,:), 'MarkerEdgeColor', clr(i,:))
end
errorbar(ax21CoS,DAve,CoSAve,CoSDev,CoSDev,DDev,DDev,'ks','LineWidth',2);
xlim(plotrangex)
ylim(plotrangeCoS)
hold(ax21CoS,'off');
ax21CoBA = subplot(2,2,3);
hold(ax21CoBA,'on');
xlb21CoBA = xlabel('Fractal Dimension (D)');
ylb21CoBA = ylabel('Profile/SA_R');
% set(ylb21CoBA, 'Units', 'Normalized', 'Position', [-0.05, 0.5, 0]);
ax21CoBA.FontSize = PlotFont;
for i = 1:BNumMods
    scatter(ax21CoBA,BDbyM(order(i),:),BPbyM(order(i),:)./(4*pi.*BRbyM(order(i),:).^2),'.','MarkerFaceColor', clr(i,:), 'MarkerEdgeColor', clr(i,:))
end
errorbar(ax21CoBA,DAve,CoBAAve,CoBADev,CoBADev,DDev,DDev,'ks','LineWidth',2);
xlim(plotrangex)
% ylim(plotrangeCoBA)
hold(ax21CoBA,'off');
ax21VF = subplot(2,2,4);
hold(ax21VF,'on');
xlb21VF = xlabel('Fractal Dimension (D)');
ylb21VF = ylabel('(V_R-V_M)/V_R');
% set(ylb21VF, 'Units', 'Normalized', 'Position', [-0.05, 0.5, 0]);
ax21VF.FontSize = PlotFont;
for i = 1:BNumMods
    scatter(ax21VF,BDbyM(order(i),:),((4*pi/3.*BRbyM(order(i),:).^3)-BVMbyM(order(i),:))./(4*pi/3.*BRbyM(order(i),:).^3),'.','MarkerFaceColor', clr(i,:), 'MarkerEdgeColor', clr(i,:))
end
errorbar(ax21VF,DAve,VFAve,VFDev,VFDev,DDev,DDev,'ks','LineWidth',2);
xlim(plotrangex)
% ylim(plotrangeVF)
hold(ax21VF,'off');
% samexaxis('abc','xmt','on','ytac','join','yld',1);
xlb21SoBA.FontSize = LabelFont;
xlb21CoS.FontSize = LabelFont;
xlb21CoBA.FontSize = LabelFont;
xlb21VF.FontSize = LabelFont;
ylb21SoBA.FontSize = LabelFont;
ylb21CoS.FontSize = LabelFont;
ylb21CoBA.FontSize = LabelFont;
ylb21VF.FontSize = LabelFont;

[~, ~, NatSoBAAve, NatSoBADev] = BinDatabyD(NatbinRange,NatNumbins,BDbyM(5,:),BSAbyM(5,:)./(4*pi.*BRbyM(order(i),:).^2));
[~, ~, NatCoSAve, NatCoSDev] = BinDatabyD(NatbinRange,NatNumbins,BDbyM(5,:),BPbyM(5,:)./BSAbyM(5,:));
[~, ~, NatCoBAAve, NatCoBADev] = BinDatabyD(NatbinRange,NatNumbins,BDbyM(5,:),BPbyM(5,:)./(4*pi.*BRbyM(order(i),:).^2));
[~, ~, NatVFAve, NatVFDev] = BinDatabyD(NatbinRange,NatNumbins,BDbyM(5,:),((4*pi/3.*BRbyM(order(i),:).^3)-BVMbyM(5,:))./(4*pi/3.*BRbyM(order(i),:).^3));
figure('Name','20','units','normalized','outerposition',[1.02 0.12 0.6 0.85])
ax20SoBA = subplot(2,2,1);
hold(ax20SoBA,'on');
xlb20SoBA = xlabel('Fractal Dimension (D)');
ylb20SoBA = ylabel('SA/SA_R');
% set(ylb20SoBA, 'Units', 'Normalized', 'Position', [-0.05, 0.5, 0]);
ax20SoBA.FontSize = PlotFont;
for i = 5
    scatter(ax20SoBA,BDbyM(order(i),:),BSAbyM(order(i),:)./(4*pi.*BRbyM(order(i),:).^2),'.','MarkerFaceColor', clr(i,:), 'MarkerEdgeColor', clr(i,:))
end
errorbar(ax20SoBA,NatDAve,NatSoBAAve,NatSoBADev,NatSoBADev,NatDDev,NatDDev,'ks','LineWidth',2);
xlim(plotrangex)
% ylim(plotrangeSoBA)
hold(ax20SoBA,'off');
ax20CoS = subplot(2,2,2);
hold(ax20CoS,'on');
xlb20CoS = xlabel('Fractal Dimension (D)');
ylb20CoS = ylabel('Connectivity (C)');
% set(ylb, 'Units', 'Normalized', 'Position', [-0.05, 0.5, 0]);
ax20CoS.FontSize = PlotFont;
% ttl20CoS = title('Basal (All Angles)');
% ttl20CoS.FontSize = TitleFont;
for i = 5
    scatter(ax20CoS,BDbyM(order(i),:),BPbyM(order(i),:)./BSAbyM(order(i),:),'.','MarkerFaceColor', clr(i,:), 'MarkerEdgeColor', clr(i,:))
end
errorbar(ax20CoS,NatDAve,NatCoSAve,NatCoSDev,NatCoSDev,NatDDev,NatDDev,'ks','LineWidth',2);
xlim(plotrangex)
ylim(plotrangeCoS)
hold(ax20CoS,'off');
ax20CoBA = subplot(2,2,3);
hold(ax20CoBA,'on');
xlb20CoBA = xlabel('Fractal Dimension (D)');
ylb20CoBA = ylabel('Profile/SA_R');
% set(ylb20CoBA, 'Units', 'Normalized', 'Position', [-0.05, 0.5, 0]);
ax20CoBA.FontSize = PlotFont;
for i = 5
    scatter(ax20CoBA,BDbyM(order(i),:),BPbyM(order(i),:)./(4*pi.*BRbyM(order(i),:).^2),'.','MarkerFaceColor', clr(i,:), 'MarkerEdgeColor', clr(i,:))
end
errorbar(ax20CoBA,NatDAve,NatCoBAAve,NatCoBADev,NatCoBADev,NatDDev,NatDDev,'ks','LineWidth',2);
xlim(plotrangex)
% ylim(plotrangeCoBA)
hold(ax20CoBA,'off');
ax20VF = subplot(2,2,4);
hold(ax20VF,'on');
xlb20VF = xlabel('Fractal Dimension (D)');
ylb20VF = ylabel('(V_R-V_M)/V_R');
% set(ylb20VF, 'Units', 'Normalized', 'Position', [-0.05, 0.5, 0]);
ax20VF.FontSize = PlotFont;
for i = 5
    scatter(ax20VF,BDbyM(order(i),:),((4*pi/3.*BRbyM(order(i),:).^3)-BVMbyM(order(i),:))./(4*pi/3.*BRbyM(order(i),:).^3),'.','MarkerFaceColor', clr(i,:), 'MarkerEdgeColor', clr(i,:))
end
errorbar(ax20VF,NatDAve,NatVFAve,NatVFDev,NatVFDev,NatDDev,NatDDev,'ks','LineWidth',2);
xlim(plotrangex)
% ylim(plotrangeVF)
hold(ax20VF,'off');
% samexaxis('abc','xmt','on','ytac','join','yld',1);
xlb20SoBA.FontSize = LabelFont;
xlb20CoS.FontSize = LabelFont;
xlb20CoBA.FontSize = LabelFont;
xlb20VF.FontSize = LabelFont;
ylb20SoBA.FontSize = LabelFont;
ylb20CoS.FontSize = LabelFont;
ylb20CoBA.FontSize = LabelFont;
ylb20VF.FontSize = LabelFont;
...
%     scatter(ax15P,BDbyM(5,:),BPbyM(5,:)./BSAbyM(5,:),'.','MarkerFaceColor',clr(5,:),'MarkerEdgeColor',clr(5,:))
...
% % %     end
% % % %     scatter(ax16P,BDbyM(5,:),BPbyM(5,:)./BSAbyM(5,:),'.','MarkerFaceColor',clr(5,:),'MarkerEdgeColor',clr(5,:))
...
% methods
    ...
    scatter(ax14P,BDbyM(5,:),BPbyM(5,:)./BSAbyM(5,:),'.','MarkerFaceColor',clr(5,:),'MarkerEdgeColor',clr(5,:))
...
%     ylim([1.3 1.9])
    ...
    % ttl14.FontSize = TitleFont;
    scatter(ax14PSAt,BDbyM(5,:),BPbyM(5,:)./BSAtbyM(5,:),'.','MarkerFaceColor',clr(5,:),'MarkerEdgeColor',clr(5,:))
...
%     ylim([1.3 1.9])
    ...
    scatter(ax14PbyM,BDbyM(5,:),BPbyM(5,:)./BMbyM(5,:),'.','MarkerFaceColor',clr(5,:),'MarkerEdgeColor',clr(5,:))
    ...
    scatter(ax14PNat,BDbyM(5,:),BPbyM(5,:),'.','MarkerFaceColor',clr(5,:),'MarkerEdgeColor',clr(5,:))
...
if ClearVarsAtEnd == 1
    clearvars -except plottingN D V P M L SA SAt SAB VM R BFbyM BDbyM BVbyM BPbyM BMbyM BLbyM BSAbyM BSAtbyM BSABbyM BVMbyM BRbyM BNumMods order Corder clr PlotFont BoxPlotFont LabelFont TitleFont
end